/* async function redirectToProductDetails(urlToFetch, urlToRedirect, sessionStorageKey, id) {
  const query = await fetchByID(urlToFetch, id);
  setSessionStorage(sessionStorageKey, query[0]);
